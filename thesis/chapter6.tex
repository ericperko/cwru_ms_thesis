...
\begin{figure}
\centering
\subfloat[HARLIE Stopped, Waiting for Obstacle to Move]{\includegraphics[width=0.75\textwidth]{images/splicing_test_pre_splice}\label{fig:splicing_test_results_pre_splice}}
\\
\subfloat[HARLIE Post-Splicing, On Spliced Arc]{\includegraphics[width=0.75\textwidth]{images/splicing_test_after_splice}\label{fig:splicing_test_results_after_splice}}
...
\centering
\ContinuedFloat
\subfloat[HARLIE Post-Splicing, Resuming Original Line Segment]{\includegraphics[width=0.75\textwidth]{images/splicing_test_post_splice_segment}\label{fig:splicing_test_results_post_splice_segment}}
